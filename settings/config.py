...
class Settings(BaseSettings):
    ...
    smtp_username: str = Field(default='807f97e48ffd49', description="Username for SMTP server")
    smtp_password: str = Field(default='1a973fee33f601', description="Password for SMTP server")
